...
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=5_out.txt ./run_single.sh 64 320
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=6_out.txt ./run_single.sh 128 320
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=7_out.txt ./run_single.sh 128 80
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=8_out.txt ./run_single.sh 128 160
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=9_out.txt ./run_single.sh 128 240
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=10_out.txt ./run_single.sh 128 320
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=11_out.txt ./run_single.sh 256 80
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=12_out.txt ./run_single.sh 256 160
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=13_out.txt ./run_single.sh 256 240
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=14_out.txt ./run_single.sh 256 320
sbatch --partition=intelv100 --exclude=ault24 --time=04:00:00 --gres=gpu:1 -n1  --cpus-per-task=8  --mem-per-cpu=4096 --output=15_out.txt ./run_single.sh 512 80
